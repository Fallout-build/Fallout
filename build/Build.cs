        ...
        ICreateGitHubRelease
{
    ...
    IEnumerable<(Project Project, string Framework)> ICompile.PublishConfigurations =>
        from project in new[]
        {
            Solution.Fallout_Cli,
            Solution.Fallout_MSBuildTasks
        }
...
#pragma warning restore FALLOUT001
    ...
    Target ICreateGitHubRelease.CreateGitHubRelease => _ => _
        ...
        .Executes(async () =>
        {
            ...
            client.Credentials = new Credentials(From<ICreateGitHubRelease>().GitHubToken.NotNull());
            ...
            var milestoneItems = milestone == null
                ? Array.Empty<Issue>()
                : (await client.Issue.GetAllForRepository(owner, name, new RepositoryIssueRequest
                {
            ...
            {
                await using var assetStream = File.OpenRead(assetPath);
