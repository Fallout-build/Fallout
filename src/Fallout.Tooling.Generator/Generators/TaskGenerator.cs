...
public static class TaskGenerator
{
    public static void Run(Tool tool, ToolWriter toolWriter)
    {
        ...
        toolWriter
            ...
            .WriteLineIfTrue(tool.NpmPackageId != null && tool.PackageExecutable != null,
            ...
            .WriteBlock(w =>
            {
                w
                    .WriteLine(
                        $"public static string {tool.Name}Path {{ get => new {tool.GetClassName()}().GetToolPathInternal(); set => new {tool.GetClassName()}().SetToolPath(value); }}")
                    .WriteLineIfTrue(tool.NuGetPackageId != null,
                        $"public const string PackageId = {tool.NuGetPackageId.DoubleQuote()};")
                    .WriteLineIfTrue(tool.PackageExecutable != null,
                        $"public const string PackageExecutable = {tool.PackageExecutable.DoubleQuote()};")
                    .WriteLineIfTrue(tool.NpmPackageId != null,
                        $"public const string PackageId = {tool.NpmPackageId.DoubleQuote()};")
                    .WriteLineIfTrue(tool.AptGetPackageId != null,
                        $"public const string PackageId = {tool.AptGetPackageId.DoubleQuote()};")
                    .WriteLineIfTrue(tool.PathExecutable != null,
                        $"public const string PathExecutable = {tool.PathExecutable.DoubleQuote()};")
                    .WriteGenericTask();
